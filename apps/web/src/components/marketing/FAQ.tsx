...
export function FAQ() {
  return (
    ...
    >
      ...
      <div className="mx-auto flex w-full flex-col items-start justify-between gap-12 md:flex-row md:px-12">
        <div className="flex w-full max-w-sm flex-col gap-1 md:sticky md:top-32">
